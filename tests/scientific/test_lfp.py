...
LFP_SYNTHETIC_WEIGHTS = str(SIM_DIR / "v5_sonata" / "sub_mini5" / "lfp_weights_synthetic.h5")
        ...
        "extra_config": {
            ...
            "reports": {
                ...
                "lfp": {
                    "type": "lfp",
                    "cells": "Mosaic",
                    "electrodes_file": LFP_SYNTHETIC_WEIGHTS,
                    "dt": 0.1,
                    "start_time": 0.0,
                    "end_time": 1.0,
                },
...
@pytest.mark.forked
def test_v5_sonata_lfp(create_tmp_simulation_config_file):
