...
def test_get_section_id():
    ...
    assert get_section_id(mock_cell, "TestCell[0].ais[4]") == 4 * 10 + 4
    assert get_section_id(mock_cell, "TestCell[0].node[5]") == 4 * 10 + 5
    assert get_section_id(mock_cell, "TestCell[0].myelin[6]") == 4 * 10 + 6
